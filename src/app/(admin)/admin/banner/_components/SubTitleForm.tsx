...
const formSchema = z.object({
  subTitle: z.string().min(1, { message: "العنوان الثاني" }),
});
    ...
    <div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isEditing && (
        <p
          className={cn(
            "text-sm mt-2",
            !initialData.subTitle && "text-slate-500 italic"
          )}
        >
          {initialData.subTitle || "لا يوجد عنوان ثاني"}
        </p>
      )}
