...
const formSchema = z.object({
  title: z.string().min(1, { message: "إسم الخبر مطلوب" }),
});
...
const CreateRecommendationPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto  flex md:items-center md:justify-center h-full p-6">
      <div>
        <h1 className="text-2xl">إسم الخبر</h1>
        <p className="text-sm text-slate-600">
          ما الإسم الذي تود تسميته للخبر؟ لا تقلق، يمكنك تغييره لاحقاً.
        </p>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      placeholder="مثال: سعر الدولار"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>ماذا ستقدم في هذه الخبر؟</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
